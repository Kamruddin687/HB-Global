...
const testimonials = [
  {
    ...
    rating: 5,
    text: "M&H Global has been our trusted recruitment partner for over 3 years. Their ability to find the right talent quickly and efficiently has been instrumental in our company's growth. Highly recommended!",
    industry: "Technology"
  },
  {
    id: 2,
    ...
    rating: 5,
    text: "The team at M&H Global understands our business needs perfectly. They've helped us build a strong leadership team and continue to deliver exceptional candidates for all our positions.",
    industry: "Retail"
  },
  {
    id: 3,
    ...
    rating: 5,
    text: "Working with M&H Global has transformed our hiring process. Their expertise in healthcare recruitment and understanding of compliance requirements is outstanding.",
    industry: "Healthcare"
  },
  {
    id: 4,
    ...
    rating: 5,
    text: "M&H Global's technical recruitment expertise is unmatched. They've helped us find top-tier developers and data scientists who have been crucial to our AI product development.",
    industry: "Technology"
  },
  {
    id: 5,
    ...
    image: "/professional-woman-ceo.jpg",
    rating: 5,
    text: "The recruitment process with M&H Global is seamless and professional. They understand the financial services industry and consistently deliver candidates who fit our culture perfectly.",
    industry: "Finance"
  }
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto">
            ...
            about their experience working with M&H Global Service Provider.
          </p>
        </div>
