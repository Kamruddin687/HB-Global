              ...
              <div className="lg:col-span-1">
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">M&H Global</h3>
                    </div>
                  </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-2 text-background/70">
                <div className="flex items-center gap-2 glass-effect px-4 py-2 rounded-full">
                  ...
                  <p className="text-sm font-medium">&copy; 2025 M&H Global Service Provider. All rights reserved.</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 glass-effect px-4 py-2 rounded-full">
                ...
                <span className="text-sm font-medium bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">by M&H Global</span>
              </div>
            </div>
          </div>
        </div>
