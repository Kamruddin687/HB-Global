...
const teamMembers = [
  {
    ...
    bio: "Sarah leads M&H Global with over 15 years of experience in executive recruitment. She has successfully placed 500+ C-level executives across various industries.",
          ...
          <div className="relative glass-effect rounded-3xl p-12 md:p-16 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto">
                ...
                people with opportunities. Explore career opportunities with M&H Global.
              </p>
