...
import { X, Send, User, Mail, Phone, Briefcase, Upload, CheckCircle, Sparkles, FileText, MapPin, GraduationCap, Award, Store } from "lucide-react"

interface RetailHospitalityResumeFormProps {
  isOpen: boolean
  onClose: () => void
}

export default function RetailHospitalityResumeForm({ isOpen, onClose }: RetailHospitalityResumeFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Retail & Hospitality Resume submitted:", submissionData)
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in-up">
      ...
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-background rounded-3xl shadow-2xl border border-border">
        {/* Header */}
        <div className="sticky top-0 z-10 bg-gradient-to-r from-pink-500/10 via-rose-500/10 to-pink-500/10 p-6 border-b border-border backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Join dynamic customer service teams</p>
            </div>
            <button
              onClick={onClose}
          ...
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500/50 transition-all"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500/50 transition-all"
                    >
                      ...
                      <option value="front-desk">Front Desk Executive</option>
                      <option value="chef">Chef/Cook</option>
                      <option value="waiter">Waiter/Server</option>
                      <option value="housekeeping">Housekeeping Staff</option>
                      <option value="customer-service">Customer Service Rep</option>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500/50 transition-all"
                      placeholder="e.g., Fashion Retail, F&B, Luxury Hotels"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full pl-12 pr-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500/50 transition-all"
                      placeholder="e.g., Food Safety, Customer Service, Hotel Management"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="glass-effect rounded-2xl p-6 space-y-6">
                ...
                {/* Preferred Sector & Availability */}
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="preferredSector" className="block text-sm font-semibold text-foreground mb-2">
                      Preferred Sector
                    </label>
                    <select
                      id="preferredSector"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="w-full p-6 border-2 border-dashed border-border rounded-xl hover:border-pink-500 transition-colors flex flex-col items-center gap-3"
                    >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full px-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500/50 transition-all resize-none"
                  placeholder="Tell us about your customer service skills, experience in retail/hospitality, and why you're interested in this position..."
                />
              </div>
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  className="flex-1 group relative px-8 py-4 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-xl font-bold text-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:scale-105"
                >
                  <span className="absolute inset-0 bg-gradient-to-r from-rose-500 to-pink-500 opacity-0 group-hover:opacity-100 transition-opacity"></span>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-xl text-muted-foreground mb-2">
                Thank you for applying to Retail & Hospitality positions.
              </p>
