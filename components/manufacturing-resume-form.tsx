...
import { X, Send, User, Mail, Phone, Briefcase, Upload, CheckCircle, Sparkles, FileText, MapPin, GraduationCap, Award, Factory } from "lucide-react"

interface ManufacturingResumeFormProps {
  isOpen: boolean
  onClose: () => void
}

export default function ManufacturingResumeForm({ isOpen, onClose }: ManufacturingResumeFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Manufacturing Resume submitted:", submissionData)
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in-up">
      ...
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-background rounded-3xl shadow-2xl border border-border">
        {/* Header */}
        <div className="sticky top-0 z-10 bg-gradient-to-r from-orange-500/10 via-amber-500/10 to-orange-500/10 p-6 border-b border-border backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Join our manufacturing excellence team</p>
            </div>
            <button
              onClick={onClose}
          ...
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all"
                    >
                      <option value="">Select Role</option>
                      <option value="production-manager">Production Manager</option>
                      <option value="quality-control">Quality Control Specialist</option>
                      <option value="machine-operator">Machine Operator</option>
                      <option value="assembly-technician">Assembly Technician</option>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all"
                      placeholder="e.g., Automotive, Electronics, Food Processing"
                    />
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className="w-full pl-12 pr-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all"
                        placeholder="B.Tech, Diploma, ITI, etc."
                      />
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full pl-12 pr-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all"
                      placeholder="e.g., Six Sigma, Lean Manufacturing, ISO 9001"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="glass-effect rounded-2xl p-6 space-y-6">
                ...
                {/* Preferred Department & Availability */}
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="preferredDepartment" className="block text-sm font-semibold text-foreground mb-2">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="w-full p-6 border-2 border-dashed border-border rounded-xl hover:border-orange-500 transition-colors flex flex-col items-center gap-3"
                    >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full px-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition-all resize-none"
                  placeholder="Tell us about your manufacturing experience, skills, and why you're interested in this position..."
                />
              </div>
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  className="flex-1 group relative px-8 py-4 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-xl font-bold text-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:scale-105"
                >
            ...
            <div className="text-center py-12">
              ...
              <p className="text-xl text-muted-foreground mb-2">
                Thank you for applying to Manufacturing positions.
              </p>
              <p className="text-muted-foreground">
                Our manufacturing recruitment team will review your application and contact you soon.
              </p>
            </div>
          )}
        </div>
